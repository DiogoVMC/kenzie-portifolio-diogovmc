        ...
        <Container>
          <HeaderContent>
            ...
            <Text type="body1" color="grey6">
              Desenvolvedor front-end de  São Paulo, Brasil. Tornando possível a criação
              de ideias atráves do equilibrio entre a criatividade e o desejo por conhecimento.
            </Text>
            <HeaderButtonsArea>
